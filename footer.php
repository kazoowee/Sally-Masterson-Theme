...
<script src="<?php get_template_directory_uri() . 'js/jquery-1.11.3.min.js?'?>"></script>
<script src="<?php get_template_directory_uri() . 'js/bootstrap.min.js?'?>"></script>
<script src="<?php get_template_directory_uri() . 'js/animsition.min.js?'?>"></script>
<script src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>
<script src="<?php get_template_directory_uri() . 'js/jquery.countdown.min.js?'?>"></script>
<script src="<?php get_template_directory_uri() . 'js/photoswipe.min.js?'?>"></script>
<script src="<?php get_template_directory_uri() . 'js/photoswipe-ui-default.min.js?'?>"></script>
<script src="<?php get_template_directory_uri() . 'js/jquery.mCustomScrollbar.concat.min.js?'?>"></script>
<script src="<?php get_template_directory_uri() . 'js/sketch.js?'?>"></script>
